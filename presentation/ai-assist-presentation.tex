...
\begin{itemize}\small
  ...
  \item \alert{Systemd user service}: \texttt{/install-service} for persistent background monitoring
\end{itemize}
\end{column}
\begin{column}{0.50\textwidth}
...
\textbf{Near-Term}
\begin{itemize}\small
  \item Multiple event sources (file events, DBUS, ...)
  \item \textcolor{green!60!black}{\checkmark} Systemd user service (\texttt{/install-service})
  \item \textcolor{green!60!black}{\checkmark} Vector-based semantic search for Knowledge Graph
...
\textbf{Future}
\begin{itemize}\small
  \item More security with sandboxing tech (Landlock or Bubblewrap)
